...
__vector_table
        ...
        DCD     EPWM9_IRQHandler           ; 166
        DCD     EPWM8_IRQHandler           ; 167
        DCD     EPWM7_IRQHandler           ; 168
        DCD     EPWM6_IRQHandler           ; 169
        DCD     EPWM5_IRQHandler           ; 170
        DCD     EPWM4_IRQHandler           ; 171
        DCD     EPWM3_IRQHandler           ; 172
        DCD     EPWM2_IRQHandler           ; 173
        DCD     EPWM1_IRQHandler           ; 174
        DCD     EPWM_TZ9_IRQHandler        ; 175
        DCD     EPWM_TZ8_IRQHandler        ; 176
        DCD     EPWM_TZ7_IRQHandler        ; 177
        DCD     EPWM_TZ6_IRQHandler        ; 178
        DCD     EPWM_TZ5_IRQHandler        ; 179
        DCD     EPWM_TZ4_IRQHandler        ; 180
        DCD     EPWM_TZ3_IRQHandler        ; 181
        DCD     EPWM_TZ2_IRQHandler        ; 182
        DCD     EPWM_TZ1_IRQHandler        ; 183
        DCD     EPWM_FIFO9_IRQHandler      ; 184
        DCD     EPWM_FIFO8_IRQHandler      ; 185
        DCD     EPWM_FIFO7_IRQHandler      ; 186
        DCD     EPWM_FIFO6_IRQHandler      ; 187
        DCD     EPWM_FIFO5_IRQHandler      ; 188
        DCD     EPWM_FIFO4_IRQHandler      ; 189
        DCD     EPWM_FIFO3_IRQHandler      ; 190
        DCD     EPWM_FIFO2_IRQHandler      ; 191
        DCD     EPWM_FIFO1_IRQHandler      ; 192
        DCD     CMP0_IRQHandler            ; 193
        DCD     CMP1_IRQHandler            ; 194
        DCD     CMP2_IRQHandler            ; 195
        DCD     CMP3_IRQHandler            ; 196
        DCD     ADC12_IRQHandler           ; 197
        DCD     ADC_FIFO12_IRQHandler      ; 198
        DCD     ADC11_IRQHandler           ; 199
        DCD     ADC_FIFO11_IRQHandler      ; 200
        DCD     ADC10_IRQHandler           ; 201
        DCD     ADC_FIFO10_IRQHandler      ; 202
        DCD     ADC02_IRQHandler           ; 203
        DCD     ADC_FIFO02_IRQHandler      ; 204
        DCD     ADC01_IRQHandler           ; 205
        DCD     ADC_FIFO01_IRQHandler      ; 206
        DCD     ADC00_IRQHandler           ; 207
        DCD     ADC_FIFO00_IRQHandler      ; 208
...
BKP_BASE        EQU     0x40001000  
;BKP_BASE_KEY    EQU     0x400010F0  
BKP_RG60_0      EQU     0x40001100  
SMP_REG         EQU     0xE00FE000  
;;STACK_BASE1     EQU     0x20000000
...
Reset_Handler
        ...
        // do not set breakpoint before this line!        

        ldr	r0, =start_ls_exit - 1	
        ldr	r1, =end_ls_exit
        ldr	r2, =sfb(CSTACK) // temporary use stack
        sub	r3, r1, r0
;       sub	r0, r0, #1
copy_ls_exit    // copy to RAM
        subs	       r3, #4
        ldr	r4, [r0], #4
        str	r4, [r2], #4
        bgt	copy_ls_exit    
        ...
        TST     R1,#1
        BNE     core1
        ldr     r1, =sizeof(CSTACK)
        lsr     r1, r1, #1
        SUB     sp, sp, r1 // core0 use lower half of stack
core1
...
SSP0_TFEINTR_IRQHandler
        ...
        PUBWEAK SSP0_TBSYINTR_IRQHandler
        SECTION .text:CODE:NOROOT(1)
SSP0_TBSYINTR_IRQHandler
        B SSP0_TBSYINTR_IRQHandler
...
SSP1_TFEINTR_IRQHandler
        ...
        PUBWEAK SSP1_TBSYINTR_IRQHandler
        SECTION .text:CODE:NOROOT(1)
SSP1_TBSYINTR_IRQHandler
        B SSP1_TBSYINTR_IRQHandler
...
UART0_IRQHandler
        ...
        PUBWEAK UART0_TBSYINTR_IRQHandler
        SECTION .text:CODE:NOROOT(1)
UART0_TBSYINTR_IRQHandler
        B UART0_TBSYINTR_IRQHandler
...
UART1_IRQHandler
        ...
        PUBWEAK UART1_TBSYINTR_IRQHandler
        SECTION .text:CODE:NOROOT(1)
UART1_TBSYINTR_IRQHandler
        B UART1_TBSYINTR_IRQHandler
...
UART2_IRQHandler
        ...
        PUBWEAK UART2_TBSYINTR_IRQHandler
        SECTION .text:CODE:NOROOT(1)
UART2_TBSYINTR_IRQHandler
        B UART2_TBSYINTR_IRQHandler
...
UART3_IRQHandler
        ...
        PUBWEAK UART3_TBSYINTR_IRQHandler
        SECTION .text:CODE:NOROOT(1)
UART3_TBSYINTR_IRQHandler
        B UART3_TBSYINTR_IRQHandler
...
EPWM1_IRQHandler
        ...
        PUBWEAK EPWM_TZ9_IRQHandler
        SECTION .text:CODE:NOROOT(1)
EPWM_TZ9_IRQHandler
        B EPWM_TZ9_IRQHandler
...
EPWM_TZ1_IRQHandler
        ...
        PUBWEAK EPWM_FIFO9_IRQHandler
        SECTION .text:CODE:NOROOT(1)
EPWM_FIFO9_IRQHandler
        B EPWM_FIFO9_IRQHandler
